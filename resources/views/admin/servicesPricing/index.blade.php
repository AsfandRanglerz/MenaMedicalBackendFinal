                                ...
                                <table class="responsive table" id="table-1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Pacakge</th>
                                            <th>Words Limit</th>
                                            <th>Price up to limit</th>
                                            <th>Price above limit</th>
                                            <th>Delivery Time</th>
                                            {{-- <th>Status</th> --}}
                                    ...
                                    <tbody>
                                        @foreach ($pricing as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($data->less_equal_price !== null)
                                                        {{ $data->less_equal_price }} $
                                                    @else
                                                        <div class="badge badge-danger">No record found</div>
                                                    @endif
                                                </td>
                                                <td>
                                                    @if ($data->above_equal_price !== null)
                                                        {{ $data->above_equal_price }} per word
                                                    @else
                                                        <div class="badge badge-danger">No record found</div>
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-4">
                                                        ...
                                                        <form action="{{ route('servicePrice.delete', $data->id) }}"
