    ...
    <div class="main-content">
        <section class="section">
            <div class="section-body">
                ...
                <form id="add_header_content_two" action="{{ route('HomeSectionOneStore') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                <h4 class="text-center my-4">Add Home Section 1</h4>
                                <div class="row mx-0 px-4">
                                    ...
                                    <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                        <div class="form-group mb-2">
                                            ...
                                            id="image_description" value="{{ old('image_description') }}" class="form-control">
