                                    ...
                                    <tbody>
                                        @foreach ($HomeSections as $HomeSection)
                                            <tr>
                                                ...
                                                {{-- <td>
                                                    @if (!empty($HomeSection->colour))
                                                        <div class="{{ $HomeSection->colour }} text-white text-center" style="width: 100px; padding: 5px;">
                                                            {{ ucfirst(str_replace('bg-', '', $HomeSection->colour)) }}
                                                        </div>
                                                    @else
                                                ...
                                                <td>
                                                    <div class="d-flex gap-4">
                                                        <a href="{{ route('main-titleEdit', $HomeSection->id) }}"
