                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body table-striped table-bordered table-responsive">
                                {{-- <a class="btn btn-success mb-3" href="{{ route('LanguageEditingFourCreate') }}">Add
                                    Content</a> --}}
                                    ...
                                    <tbody>
                                        @foreach ($LanguageEditingFours as $LanguageEditingFour)
                                            <tr>
                                                ...
                                                <td>
                                                    @if(!empty($LanguageEditingFour->main_title))
                                                    {{ $LanguageEditingFour->main_title }}
                                                    @else
                                                ...
                                                <td>
                                                    @if(!empty($LanguageEditingFour->description ))
                                                ...
                                                <td>
                                                    @if (!empty($LanguageEditingFour->main_image))
                                                ...
                                                <td>
                                                    <div class="d-flex gap-4">
                                                        ...
                                                        <a href="{{ route('LanguageEditingFourEdit', $LanguageEditingFour->id) }}"
                                                            class="btn btn-primary" style="margin-left: 10px">
                                                            <span class="fas fa-edit"></span> </a>
                                                        {{-- <form
                                                            action="{{ route('LanguageEditingFourDestroy', $LanguageEditingFour->id) }}"
