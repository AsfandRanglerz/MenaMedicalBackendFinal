                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body table-striped table-bordered table-responsive">
                                {{-- <a class="btn btn-success mb-3" href="{{ route('HomeSectionSixCreate') }}">Add
                                    Content</a> --}}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-4">
                                                        <a href="{{ route('HomeSectionThree') }}"
                                                            class="btn btn-primary" style="margin-left: 10px">
                                                            <span class="fas fa-image"></span> </a>

                                                        <a href="{{ route('HomeSectionSixEdit', $HomeSection->id) }}"
                                                            class="btn btn-primary" style="margin-left: 10px">
                                                            <span class="fas fa-edit"></span> </a>

                                                            
                                                        {{-- <form
                                                            action="{{ route('HomeSectionSixDestroy', $HomeSection->id) }}"
