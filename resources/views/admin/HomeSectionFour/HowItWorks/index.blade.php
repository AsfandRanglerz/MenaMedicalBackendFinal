                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <a class="btn btn-primary mb-3" href="{{ route('HomeSectionFour') }}">Back</a>  
                                {{-- <a class="btn btn-success mb-3" href="{{ route('HomeSectionFourCreate') }}">Add
                                    Content</a> --}}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-4">
                                                        <a href="{{ route('WorksEdit', $HomeSection->id) }}"
                                                            class="btn btn-primary" style="margin-left: 10px">
                                                            <span class="fas fa-edit"></span> </a>
                                                        {{-- <form
                                                            action="{{ route('HomeSectionFourDestroy', $HomeSection->id) }}"
