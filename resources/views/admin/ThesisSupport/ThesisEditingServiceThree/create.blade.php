    ...
    <div class="main-content">
        <section class="section">
            <div class="section-body">
                <a class="btn btn-primary mb-3" href="{{ route('ThesisEditingServiceThree') }}">Back</a>
                <form id="add_header_content_two" action="{{ route('ThesisEditingServiceThreeStore') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                <h4 class="text-center my-4">Add Thesis Editing Service 3</h4>
