                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body table-striped table-bordered table-responsive">
                                {{-- <a class="btn btn-success mb-3" href="{{ route('LanguageEditingOneCreate') }}">Add
                                    Content</a> --}}
                                    ...
                                    <tbody>
                                        @foreach ($LanguageEditings as $LanguageEditing)
                                            <tr>
                                                ...
                                                <td>
                                                    @if(!empty($LanguageEditing->title))
                                                    {{ $LanguageEditing->title }}
                                                    @else
                                                    <span class="text-muted">No Title</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    @if(!empty($LanguageEditing->description ))
                                                ...
                                                <td>
                                                    @if(!empty($LanguageEditing->image))
                                                ...
                                                <td>
                                                    <div class="d-flex gap-4">
                                                        <a href="{{ route('LanguageEditingOneEdit', $LanguageEditing->id) }}"
                                                            class="btn btn-primary" style="margin-left: 10px">
                                                            <span class="fas fa-edit"></span> </a>
                                                        {{-- <form
                                                            action="{{ route('LanguageEditingOneDestroy', $LanguageEditing->id) }}"
