                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body table-striped table-bordered table-responsive">
                                {{-- <a class="btn btn-success mb-3" href="{{ route('ScientificEditingOneCreate') }}">Add
                                    Content</a> --}}
                                        ...
                                        @foreach ($ScientificEditings as $ScientificEditing)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {!! nl2br (e($ScientificEditing->description)) !!}
                                                    @else
                                                ...
                                                <td>
                                                    <div class="d-flex gap-4">
                                                        <a href="{{ route('ScientificEditingOneEdit', $ScientificEditing->id) }}"
                                                            class="btn btn-primary" style="margin-left: 10px">
                                                            <span class="fas fa-edit"></span> </a>
                                                        {{-- <form
                                                            action="{{ route('ScientificEditingOneDestroy', $ScientificEditing->id) }}"
