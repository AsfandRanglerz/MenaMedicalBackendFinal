            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" id="mymodal" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-center">
                        <button type="button" class="btn btn-success button-color update-privacy">Update</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
                ...
                "columns": [
                    ...
                    // Action buttons column
                    {
                        ...
                        "render": function(data, type, row) {
                            return '<button class="btn btn-success button-color mb-3 mr-3 text-white editSubadminBtn" data-id="' +
        ...
        $(document).on('click', '.editSubadminBtn', function() {
            var id = $(this).data('id');
            var url = "{{ route('privacy.edit', ':id') }}".replace(':id', id);
            window.location.href = url
        });

        function editHobby(id) {
            var privacyShow = '{{ route('privacy.edit', ':id') }}';
            $.ajax({
