    ...
    <div class="main-content">
        <section class="section">
            <div class="section-body">
                ...
                <form id="add_header_content_Three" action="{{ route('ManuscriptFormattingThreeStore') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                <h4 class="text-center my-4">Add Manuscript Formatting Section 3</h4>
