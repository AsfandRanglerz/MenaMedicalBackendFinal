                    ...
                    <div class="col-md-8">
                        <form action="" class="mena-form" id="createQuotationForm">
                                    ...
                                    <div class="advance-table-container">
                                        <table>
                                            <thead>
                                                ...
                                                <input type="text" value="{{$package}}" name="package" id="package" hidden>
                                                <tr>
                                                    <th colspan="3" class="header">
                                                        <div
                                                            class="d-flex align-items-center justify-content-between px-3 py-2">
                            ...
                            <div class="section-devision">
                                            ...
                                            <tbody>
                                                @foreach ($additionalsServices as $data)
                                                    <tr>
                                                        <td>
                                                            <label>
                                                                <input type="checkbox" name="additional_price_cat" value="{{$data->additional_services}}" class='m-2 additional_price_check'>
                                                                {{$data->additional_services}}
                                                            </label>
                                                        </td>
                                                        <td>USD <span class="additional_price_cat_value">{{$data->basic_package_price}}</span></td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                ...
                                <p class="m-0 mt-1 font-500 small">*Plagiarism Check and Manuscript Formatting are already included in Premium Editing service Price for Plagiarism Check and Manuscript Formatting displayed above is for up to 6,000 words. There will be a customized charge for longer documents.</p>
                            </div>
                            @endif
                            <div class="section-devision">
                                <div class="d-flex align-items-center gap-2 px-3 py-3 heading-band">
                                    <img src="{{ asset('public/assets/images/Path 328.png') }}" class="arrow">
                                    <p class="text-white m-0 font-500">STEP {{$package == 'Advance' ? '3' : '2'}} – Upload Document</p>
                                </div>
                                            ...
                                            <table class="set-width">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <label>
                                                                <input type="radio" name="requirement" value="Edit the entire document">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <label>
                                                                <input type="radio" name="requirement" value="Edit the highlighted sections only">
                                                                Edit the highlighted sections only <a href="#" class="text-decoration-none" style="font-size: 0.8rem">(sections should be highlighted in yellow)</a>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                </tbody>
                            ...
                            <div class="section-devision">
                                <div class="d-flex align-items-center gap-2 px-3 py-3 heading-band">
                                    <img src="{{ asset('public/assets/images/Path 328.png') }}" class="arrow">
                                    <p class="text-white m-0 font-500">STEP {{$package == 'Advance' ? '4' : '3'}} – Contact Details</p>
                                </div>
...
<script>
        ...
        $(document).ready(function() {
            ...
            $("input[name='price_cat']").change(function() {
                ...
                $('#service_name').text($("#package").val() + ' Language Editing - ' + selectedPriceCategory); // Concatenate package name and text
        ...
        $(document).ready(function () {
            ...
            $("input[name='additional_price_cat']").change(function () {
                ...
                group1.each(function () {
                    if ($(this).is(":checked")) {
                        group1.not(this).prop("checked", false); // Uncheck the other checkbox in the group
                    }
                });
                ...
                group2.each(function () {
                    if ($(this).is(":checked")) {
                        group2.not(this).prop("checked", false); // Uncheck the other checkbox in the group
                    }
                });
    ...
    $(document).on('click', '#calculatePrice', function() {
        ...
        if (additionalPriceCat.length > 0) {
            additionPriceValue = additionalPriceCat.closest('tr').find('.additional_price_cat_value').text(); // Fetch price from span
    ...
    $('#submit-quotation').on('click', function() {
        ...
        var formData = new FormData();
            ...
            formData.append('requirement', ($('#createQuotationForm input[name="requirement"]').val() || '').trim());
            formData.append('additional_service', ($('input[name="additional_price_cat"]:checked').val() || '').trim());
