            ...
            <div class="section-devision">
                ...
                <div class="d-block d-sm-none overflow-auto lang-table-section">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td colspan="4" class="py-2 px-3 text-center large-column">Spelling, Punctuation, and
                                    Grammar Check</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="4" class="py-2 px-3 text-center large-column">Word Count Reduction</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="4" class="py-2 px-3 text-center large-column">Flow, Logic, and Clarity Check
                                </td>
                            </tr>
                            <tr>
                                <td class="text-center py-2">
                            ...
                            <tr>
                                <td colspan="4" class="py-2 px-3 text-center large-column">Plagiarism check by iThenticate*
                                </td>
                            </tr>
                            <tr>
                                <td class="text-center py-2">
                            ...
                            <tr>
                                <td colspan="4" class="py-2 px-3 text-center large-column">Manuscript Formatting*</td>
                            </tr>
                            <tr>
                                <td class="text-center py-2">
                                    <img src="{{ asset('public/assets/images/Path 23.png') }}" class="tick-cross">
                            ...
                            <tr>
                                <td colspan="4" class="py-2 px-3 text-center large-column">Editing of References</td>
                            </tr>
                            <tr>
                                <td class="text-center py-2">
                                    <img src="{{ asset('public/assets/images/Path 23.png') }}" class="tick-cross">
                            ...
                            <tr>
                                <td colspan="4" class="py-2 px-3 text-center large-column">Cover letter customized for
                            ...
                            <tr>
                                <td colspan="4" class="py-2 px-3 text-center large-column">Reviewer Response Letter Editing
                            ...
                            <tr>
                                <td colspan="4" class="py-2 px-3 text-center large-column">Re-editing support for 180 days
                                ...
                                <thead>
                                    ...
                                    <tr class="category-header">
                                        <th style="font-size: 0.9rem;"
                                            ...
                                            Basic Editing</th>
                                        <th style="font-size: 0.9rem;"
                                            class="text-white font-600 px-2 text-center advanced-column">Advanced Editing
                                        </th>
                                        <th style="font-size: 0.9rem;"
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-white">
                                        <td style="width: 25%;" class="px-1"><a
                                                ...
                                                Quote</a></td>
                                        <td class="px-1"><a href="{{ url('/language-editing-service-form/Advance') }}"
                                                class="px-1 py-1 theme-btn-green" style="text-decoration: none;">Get a
                                                Quote</a></td>
                                        <td class="px-1"><a href="{{ url('/language-editing-service-form/Premium') }}"
                                                class="px-1 py-1 theme-btn-green" style="text-decoration: none;">Get a
                                                Quote</a></td>
                                    </tr>
                                </tbody>
