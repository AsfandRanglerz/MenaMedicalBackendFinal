...
@section('title', 'Scientific Assignment Service')

@section('content')
    <div class="container-fluid">
        <div class="container-fluid">
            <div class="container-fluid section-devision">
                <h4 class="primary-heading">Scientific Assignment Service</h4>
                <div class="row mt-4">
                    <div class="col-md-8">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label>
                                                            <input type="radio" name="price_category">
                                                            Manuscript Formatting** - Discounted price for MENA students &
                                                            researchers
                                                        </label>
                                                    </td>
                                                    <td>USD 110</td>
