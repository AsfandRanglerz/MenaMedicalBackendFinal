                    ...
                    <div class="col-md-8">
                        ...
                        <form action="" class="mena-form" id="createQuotationForm">
                                        ...
                                        <table>
                                            <thead>
                                                ...
                                                <tr class="text-center">
                                                    <th colspan="2" class="px-3 py-2 head-one font-600">Select Price Category</th>
                                                </tr>
                                                <tr class="category-header">
                                                    <th class="text-white font-600 text-center price-column">Price</th>
                                                    <th class="text-white font-600 text-center text-nowrap py-2 px-2 delivery-column">Delivery
                                                        Time
                                                    </th>
                                                </tr>
                                            </thead>
                                                            ...
                                                            <td>
                                                                <label>
                                                                    <input type="checkbox" name="additional_price_cat"
                                                                        value="{{ $data->additional_services }}" class='m-2 additional_price_check'>
                            ...
                            <div class="section-devision">
                                <div class="d-flex align-items-center gap-2 px-3 py-3 heading-band">
                                    <img src="{{ asset('public/assets/images/Path 328.png') }}" class="arrow">
                                    <p class="text-white m-0 font-500">STEP {{ $package == 'Premium' ? '2' : '3' }} – Upload
                                        Document</p>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $("input[name='price_cat']").change(function() {
                ...
                $('#service_name').text($("#package_name").val() + ' Language Editing - ' + selectedPriceCategory); // Concatenate package name and text
