...
@section('title', $package . ' Editing Service')
    ...
    <div class="container-fluid">
        <div class="container-fluid">
            <div class="container-fluid section-devision">
                ...
                <div class="row mt-4">
                    <div class="col-md-8">
                        <input type="text" value="{{ $package }}" name="package_name" id="package_name" disabled hidden>
                        <form action="" class="mena-form" id="createQuotationForm">
                            <div>
                                ...
                                <div class="overflow-auto">
                                    ...
                                    <div class="d-none d-sm-table advance-table-container">
                                        <table>
                                            <thead>
                                        ...
                                        <table>
                                            <thead>
                                                ...
                                                <tr class="category-header">
                                                    <th class="text-white font-600 text-center price-column">Price</th>
                                                    <th
                                                        class="text-white font-600 text-center text-nowrap py-2 px-2 delivery-column">
                                                        Delivery Time</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach ($newPrices as $data)
                                                    ...
                                                    <tr>
                                                        <td class="text-center">USD <span
                                                                class="price_display">{{ $data->price }}</span></td>
                                                        <td><span class="days_display">{{ $data->delivery_time }}</span>
                                                            days</td>
                                                    </tr>
                                                @endforeach
                                ...
                                <p class="m-0 mt-1 font-500">Additional words above 6,000 words will be charged at a fix rate of USD 40 per thousand words
</p>
                            </div>
                            @if ($package == 'Basic' || $package == 'Advance')
                                <div class="section-devision">
                                                    ...
                                                    @foreach ($additionalsServices as $data)
                                                        <tr>
                                                            ...
                                                            @elseif ($package == 'Advance')
                                                                <td>USD <span
                                                                        class="additional_price_cat_value">{{ $data->advance_package_price }}</span>
                                                                </td>
                                                            @endif
                                                        </tr>
                                                    @endforeach
                                    ...
                                    <p class="m-0 mt-1 font-500 small">*Plagiarism Check and Manuscript Formatting charges displayed above are for up to 6,000 words.
                                        Additional charges will apply for word count above 6,000 words.</p>
                                </div>
                            @endif
                            <div class="section-devision">
                                <div class="d-flex align-items-center gap-2 px-3 py-3 heading-band">
                                    <img src="{{ asset('public/assets/images/Path 328.png') }}" class="arrow">
                                    <p class="text-white m-0 font-500">STEP {{ $package == 'Premium' ? '2' : '3' }} –
                                        Upload
                                        Document</p>
                                </div>
                            ...
                            <div class="section-devision">
                                <div class="d-flex align-items-center gap-2 px-3 py-3 heading-band">
                                    <img src="{{ asset('public/assets/images/Path 328.png') }}" class="arrow">
                                    <p class="text-white m-0 font-500">STEP {{ $package == 'Premium' ? '3' : '4' }} –
                                        Contact Details</p>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $("input[name='price_cat']").change(function() {
                ...
                console.log("Selected Price Category:", selectedPriceCategory);
                // let price = 0;
                // let days = 0;
        ...
        $(document).ready(function() {
            $("input[name='additional_price_cat']").change(function() {
                // var group1 = $("input[name='additional_price_cat']").slice(0, 2);
                // var group2 = $("input[name='additional_price_cat']").slice(2, 4);
                ...
                //     if ($(this).is(":checked")) {
                //         group2.not(this).prop("checked", false);
                //     }
                // });
                updatePrice();
            });
        ...
        $(document).on('click', '#calculatePrice, #calculatePrice2', function() {
            ...
            $.ajax({
                url: '{{ route('languageEditingService.calculatePrice') }}', // Replace with your server endpoint
                method: 'POST',
                headers: {
        ...
        $('#submit-quotation, .submit-quotation').on('click', function() {
            ...
            formData.append('price_category', ($('input[name="price_cat"]:checked').val()));
            ...
            // Send AJAX request
            $.ajax({
                url: '{{ route('languageEditingService.submit.request') }}',
                method: 'POST',
                headers: {
                    'X-CSRF-Token': '{{ csrf_token() }}',
                },
